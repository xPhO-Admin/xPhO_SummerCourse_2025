...
\end{figure}
Ở đây ta đã biểu diễn \(\mathbf{e}_3\), \(\mathbf{e}_4\) thông qua \(\mathbf{e}_1\), \(\mathbf{e}_2\)-để thuận tiện. Tức về mặt con số, cơ sở vector là hai vector trực chuẩn được đánh số 1,2. 
...
\begin{enumerate}[label=(\alph*)]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{Tuan2/Figures/realaxis.png}
    \end{figure}
