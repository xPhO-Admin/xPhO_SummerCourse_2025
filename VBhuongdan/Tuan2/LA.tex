...
\end{bmatrix}\rightarrow L\rightarrow L(\mathbf{v})=\begin{bmatrix}
    2\\2.5
\end{bmatrix}.\] Nhắc lại, ta đạt được \(L(\mathbf{v})\) điều này bằng cách nhân \(\mathbf{v}\) với ma trận chuẩn \(\mathbf{A}\), đây đơn giản là lấy 1 nhân với \(L(\mathbf{e}_1)\) (cột thứ nhất của \(\mathbf{A}\)) rồi cộng với 0.5 nhân \(L(\mathbf{e}_2)\) (cột thứ hai của \(\mathbf{A}\)).
