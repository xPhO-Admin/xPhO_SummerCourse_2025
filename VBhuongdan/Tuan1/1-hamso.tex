...
\begin{definition}
    Ta viết $$\lim_{x\rightarrow a^-}f(x)=L$$
...
\begin{theorem}
    $$\lim_{x\rightarrow a}f(x)=L \leftrightarrow \lim_{x\rightarrow a^-}f(x)=L, \lim_{x\rightarrow a^-}f(x)=L.$$
\end{theorem}
...
\end{definition}
Điều này dễ hiểu nếu xét hàm $1/x$ : lấy 1 chia 100, rồi lấy 1 chia $10$, chia $0.1$, $0.01,...$ kết quả thu được sẽ ngày càng lớn. Nếu lấy 1 chia $1/10^6$, sẽ có được $10^6$. Và cứ thế.
Chú ý rằng vô hạn không phải một con số. Nó, ở đây, là một giới hạn.\newline
Ta cũng có thể có điều ngược lại:$$\lim_{x\rightarrow\infty}f(x)=L$$ hay, $$\lim_{x\rightarrow\infty}f(x)=\infty.$$ 
\vspace{5pt}

Để kết thúc phần này, ta sẽ thừa nhận và tổng kết những tính chất sau:
